...
export const liveSites: LiveSite[] = [
  {
    ...
    description: "The public home for Metaventions AI and its independent work on AI tools and connected knowledge.",
    url: "https://metaventionsai.com",
  },
  {
    name: "Career Board",
    tech: "CAREER APPLICATION",
    description: "AI-assisted career workflows for résumé review, role comparison and career planning.",
    url: "https://careers.metaventionsai.com",
  },
  {
    name: "OS-App",
    tech: "APPLICATION PROTOTYPE",
    description: "A prototype interface for working with multiple AI models, voice and agent workflows.",
    url: "https://app.metaventionsai.com",
  },
  {
    name: "Frontier Alpha",
    tech: "FINANCE RESEARCH PROTOTYPE",
    description: "An experimental interface for exploring factor exposure, portfolios and AI-assisted investment research.",
    url: "https://frontier-alpha.metaventionsai.com",
  },
  {
    name: "The Signature Event",
    tech: "PUBLISHED EVENT WEBSITE",
    description: "A website for The Signature Event in Miami, with a recap and photo gallery from February 2026.",
    url: "https://thesignatureevent.metaventionsai.com",
  },
  {
    name: "BXLENCE Hospitality",
    tech: "HOSPITALITY WEBSITE",
    description: "A hospitality and event website presenting destinations, experiences and membership information.",
    url: "https://bxl.metaventionsai.com",
  },
  {
    name: "FriendlyFace",
    tech: "AI EVIDENCE PROTOTYPE",
    description: "A prototype exploring evidence records and traceability for AI systems.",
    url: "https://friendlyface.metaventionsai.com",
  },
  {
    name: "The Partnership Graph",
    tech: "CONCEPT DEMO / ILLUSTRATIVE DATA",
    description: "A partner-intelligence interface exploring partner health, co-sell workflows and revenue attribution with illustrative data.",
