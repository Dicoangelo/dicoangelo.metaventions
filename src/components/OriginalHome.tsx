...
// Loading skeletons
import { JDAnalyzerSkeleton } from "@/components/LoadingSkeletons";
...
export default function OriginalHome() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("pageshow", restoreSection);
    return () => {
      cancelAnimationFrame(frame);
      observer?.disconnect();
      window.removeEventListener("hashchange", restoreSection);
      window.removeEventListener("load", restoreSection);
      window.removeEventListener("pageshow", restoreSection);
    };
  }, []);

  return (
    <main id="main-content" tabIndex={-1} role="main" className="min-h-screen">
      ...
      <section id="analyze" className="relative py-20 px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            >
              Compares a job description with my verified career profile. AI estimates highlight relevant experience and areas to discuss.
            </p>
          </div>
