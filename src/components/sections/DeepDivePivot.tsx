...
const CARDS: PivotCard[] = [
  {
    ...
    body: "Architecture and workflow snapshots across five independent AI-assisted systems.",
  ...
  },
  {
    ...
    body: "Reflect on your AI workflows across five informal self-assessment dimensions.",
    tag: "Self-assessment",
    accent: "#10b981",
  },
  {
    ...
    body: "Independent system architecture, illustrative code examples, and an interactive 3D network.",
    tag: "9 systems · 3D",
    accent: "#8b5cf6",
  },
  {
    ...
    body: "How operations experience informs AI-assisted workflow design, implementation, and review.",
