  ...
  const events: TimelineEvent[] = [
    {
      ...
      location: "Massachusetts / Bentley University",
      type: "achievement",
      description: "Volunteer leadership role mentoring 3 students from New England universities through the Mass Fintech Hub Mentoring Program. Joined the cohort onsite at the Bentley University Blockchain Bootcamp in April 2026.",
      highlights: [
        "Mentoring 3 students in fintech, AI, and operations infrastructure careers",
        "Attended Bentley University Blockchain Bootcamp with the MFTH cohort (Apr 2026)",
      ...
      metrics: ["3 Mentees", "Bentley Bootcamp", "Volunteer Leadership"],
    },
    {
      date: "Mar 2026",
      title: "Blockchain & Web3 Community",
