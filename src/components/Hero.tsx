  ...
  return (
    <section id="hero" className="pt-32 pb-20 px-6 relative overflow-hidden min-h-[90vh] flex flex-col justify-center">
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        >
          <strong className="text-[#6366f1] font-bold">$800M+</strong> in cloud marketplace operations
          across AWS and Microsoft (<strong>2x MSFT Partner of the Year</strong>).
