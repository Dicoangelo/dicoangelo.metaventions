  ...
  return (
    <section className="pt-32 pb-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        {/* Status Badge */}
        <div
          className={`mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-full border text-sm animate-fade-in animate-delay-100 ${
            isLight ? 'bg-white border-gray-200 shadow-sm' : 'bg-[#141414] border-[#262626]'
          }`}
          role="status"
          aria-live="polite"
        >
        ...
        {/* Value Proposition */}
        <p
          className={`text-xl mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in animate-delay-300 ${
        ...
        <div className="flex gap-4 justify-center mb-8 flex-wrap animate-fade-in animate-delay-400">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`group px-8 py-4 border-2 rounded-xl font-semibold transition-all hover:scale-105 flex items-center gap-2 ${
              isLight
        ...
        {/* Quote */}
        <p
          className={`text-sm italic animate-fade-in animate-delay-500 ${
