...
I do **not** claim language fluency in TypeScript, JavaScript, Python, SQL, or Bash. I do not benchmark against engineers with those backgrounds. If a role requires "5 years TypeScript" or "expert Python," I am not the candidate. If a role requires the ability to design AI systems and ship them through prompt-driven orchestration, that is the work I have actually done.
...
I do **not** claim language fluency in TypeScript, JavaScript, Python, SQL, or Bash. The code in these systems is generated by AI tools I direct; I am responsible for architecture, prompts, review, evaluation, and deployment — not hand-written syntax.
...
I do not claim hand-fluency in TypeScript, JavaScript, Python, SQL, or Bash. The code these tools produce is generated under my direction — I own architecture, prompt specs, review, evaluation, and deployment.
