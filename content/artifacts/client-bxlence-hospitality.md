# Client Project: Bxlence Hospitality
...
| Purple | #8E24AA |
| Black | #08090F |
| Typography | Montserrat (headings), Lato (body), Playfair Display (accent) |

## Key Outcomes

- Complete luxury hospitality platform from concept to production
- 15+ pages with server components and dynamic routing
- 30+ custom animation components built from scratch
- Stripe payment integration for 3-tier membership ($2,500-$invitation)
- Supabase backend for leads, contacts, and membership data
- Event packages priced at $15K-$35K+ for luxury event production
- Multi-city expansion framework (destinations with waitlist system)
- Cross-project integration with The Signature Event (shared gallery assets)
...
- **Multi-Stakeholder Management:** Co-founder role balancing business and technical decisions
- **Scalable Architecture:** City-based expansion framework, dynamic content routing
- **Cross-Project Delivery:** Shared assets and gallery between BXL and Signature Event platforms
- **Revenue Model Implementation:** Membership tiers, event packages, B2B service pricing

## Key People

| Person | Role |
|--------|------|
| **Mirando Atemici** | Founder, Operations & Hospitality |
| **Dico Angelo** | Co-Founder, Technology & Design |
